...
We characterise model misspecification due to genotyping errors in
[Understand genotyping
errors](https://aimeertaylor.github.io/Pv3Rs/articles/genotyping-errors.html).

We have not yet characterized misspecification due to stranger parasites
