...
#'   used; see \code{\link{determine_MOIs}}. Because the Pv3Rs model does not
#'   account for genotyping errors, including false positive alleles,
#'   user-specified MOIs must be greater than or equal to those generated by
#'   [determine_MOIs()].
