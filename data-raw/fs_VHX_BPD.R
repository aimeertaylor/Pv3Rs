...
# version of the package (it is listed under .Rbuildignore). Real data in
# MS_data_PooledAnalysis.RData downloaded from the following link and saved in
# the same directory as this file: https://zenodo.org/records/3368828.
#################################################################################
