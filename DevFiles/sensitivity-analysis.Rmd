...
**Note: ** This is the original version genotyping error investigation. It has been superseded by the article "Understand genotyping errors".
...
for(i in c(2, 35, 34)) { # used to be 2, 6, 34
...
In practice, there is no way of knowing the output based on error-free data. We
recommend using small marker subsets in favour of ensuring a low probability of
