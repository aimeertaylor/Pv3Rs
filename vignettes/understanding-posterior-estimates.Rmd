...
parasites in the first episode are siblings.
...
Given equally likely recurrent states *a priori*, as the data increase with the number of markers genotyped posterior probabilities converge to either
...
all_As <- as.list(sapply(ms, function(t) "A")) # List of As for all markers
all_Bs <- as.list(sapply(ms, function(t) "B")) # List of Bs for all markers
