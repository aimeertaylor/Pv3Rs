...
<span style="color: darkorange;">ONO</span>: For match data (upward triangles),
strong evidence for a clonal edge between episodes one and three is incompatible
with all recurrence sequences ending with reinfection *and* reinfection followed
by recrudescence, pushing the second upward orange triangle to the simplex edge
*and* the first upward orange triangle away from the prior.

By comparison, strong evidence for a clonal edge between episodes two and three
(style="color: darkgreen;">NO**O**</span>, match) is incompatible with all
sequences of recurrences ending with reinfection, pushing the second upward
green triangle away from the prior, but not the first upward green triangle;
likewise, strong evidence for a clonal edge between episodes one and two (<span
style="color: purple;">OON</span>, match) is incompatible with all sequences of
recurrences starting with reinfection, pushing the first upward purple triangle
away from the prior but not the second.
...
The explanation for mismatch data in the sequence <span style="color:
darkorange;">ONO</span>: is similar as that for match data: strong evidence for
