...
- recrudescence with posterior probability less than one, 
- reinfection with posterior probability less than one.

The maximal posterior probabilities of recrudescence and reinfection depend on
number of genotypes per episode, the number of episodes, and on the position of
the recurrence in the sequence of episodes.
