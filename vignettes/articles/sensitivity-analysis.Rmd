...
In summary, marker subsetting with small subset size shows promise for
identifying and correcting the misclassification of recrudescence due to
genotyping errors and mutations. The use of subsetting for relapse and
reinfection misclassification is less straight forward, but relapse and
reinfection are less impacted errors.
