...
graphs; see `vignette("graph-prior", "Pv3Rs")`.
...
on knowledge that there are no recurrent data on all but the first recurrence; see `vignette("graph-prior", "Pv3Rs")`.
...
relapse versus reinfection; see `vignette("half-siblings", "Pv3Rs")`. The purple, red,
...
conditions; again, see `vignette("half-siblings", "Pv3Rs")`.
