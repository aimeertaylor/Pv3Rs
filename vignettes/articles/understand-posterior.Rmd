...
# Data 
match <- list(enrol = list(m1 = "A"), recur1 = list(m1 = "A"))
mismatch <- list(enrol = list(m1 = c("A")), recur1 = list(m1 = "B"))
parmatch <- list(enrol = list(m1 = c("A", "B")), recur1 = list(m1 = "A"))
...
# Data 
match <- list(enrol = A_A, recur1 = A_A)
mismatch <- list(enrol = A_A, recur1 = B_B)
parmatch <- list(enrol = AB_A, recur1 = A_A)
match_mismatch <- list(enrol = A_A, recur1 = A_B)
...
graphs; see vignette(topic = "graph-prior", package = "Pv3Rs"). <!-- no back
ticks because pkgdown cannot link to pdf vignettes -->
