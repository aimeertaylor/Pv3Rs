...
estimates. These examples also highlight why, under a well-specified model,
...
inform the first recurrence, causing its posterior estimate to deviate from the
...
[episode counts](#epi-counts) have different maximum probabilities of
