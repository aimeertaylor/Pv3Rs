...
Another consequence of genotyping error, specifically false positivity, is
spuriously high multiplicity of infection. Because there is a computational
...
more), false positives might render some recurrences unanalysable. Among those
that are analysable, false postives might impact probable recrudescence
and probable reinfection probabilities because different parasite genotype
counts induce different posterior bounds on these states. 
...
where the reinfection probability is overestimated. This is likley due to a false
positives changing the posterior bound.
