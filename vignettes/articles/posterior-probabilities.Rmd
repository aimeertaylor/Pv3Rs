...
[Understand genotyping errors](https://aimeertaylor.github.io/Pv3Rs/articles/genotyping-errors.html).

We have not yet characterized misspecification due to stranger parasites with
elevated relatedness:

- Stranger parasites that are related insofar as the population is related on
average are accounted for: Allele frequency estimates encode
...
proximity in space and time) will likely lead to the misclassification of
...
priori*, we can discount *a priori* all trial participants with a single
...
parent 1 draws alleles disproportionally to parent 2. The admixture
