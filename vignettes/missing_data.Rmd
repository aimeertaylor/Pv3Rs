...
If there are no informative intra-episode data and no inter-episode data on a common marker, compute_posterior returns the prior, which in this case is re-weighted to the exclusion of recrudescence: 
