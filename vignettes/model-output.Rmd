...
specifically, when the model is well specified, we document the output of
`compute_posterior` when there are
...
### Heteroallelic data on only one episode with MOI necessarily greater than one
...
### Homoallelic data on only one episode with input MOI greater than one
...
#### Dependence on the number of recurrences
...
legend("bottomright", pch = 20, bty= "n", cex = 0.5, 
