---
title: "Understanding model output"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Understanding model ouput}
...
the prior because rare intra-episode allelic repeats limit the likelihood to
summation over relationship graphs with intra-episode relatedness. We can use
different MOIs to demonstrate this: changing the MOIs changes the distribution
over relationship graphs, and thus the posterior value.
...
episode parasites are all siblings (note the log scale).

```{r, fig.height = 5, out.width="50%"}
# ------------------------------------------------------------------------------
# Maximum likelihood graphs for an illustrative case with MOIs 3 & 2
# ------------------------------------------------------------------------------
# Classify graphs
...
edges_1st <- igraph::as_ids(igraph::E(graph)) # Graph edges of the 1st episode 
RGs_edges <- lapply(gd$RGs, function(RG) igraph::as_ids(igraph::E(RG)))
...
plot(llikes_sorted$x, pch = 20, cex = 0.5, col = "cornflowerblue", bty = "n",
