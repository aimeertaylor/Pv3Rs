...
if they are independent). In practice, when MOIs under the Pv3Rs modesl are
based on estimates from bulk (not single-cell) parasite genetic data, groups of
three or more siblings are modelled as groups of two; 
see [vignetter("intra-episode-siblings")](intra-episode-siblings.html).
