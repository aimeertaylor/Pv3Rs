...
[vignette("graph-prior")](graph-prior.pdf).
...
To assess data informativeness, we could report relative uncertainty: how far an
estimate under the joint posterior is from its maximum, which can be computed *a
priori*; [vignette("graph-prior")](graph-prior.pdf).
...
[vignette("half-siblings")](half-siblings.pdf). The
...
reinfection under certain conditions; again, 
see [vignette("half-siblings")](half-siblings.pdf). 
