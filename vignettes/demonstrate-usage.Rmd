...
1) Plot data
2) Estimate recurrence state probabilities 
...
counts. In reality, more diverse markers are recommended for recurrence state
...
counts across many markers were available, they could be used in recurrence state
...
plot_simplex(p.coords = p.coords)
```
