...
in the three episodes respectively (a genotype is here defined as a haploid DNA sequence, which is distinct within episode, and represents a group of parasites). In this synthetic example, markers
are quart-allelic for brevity; this imposes a rather low upper bound on MOI estimates based on maximum
